...
public class ContactDataSource {
	...
	public ArrayList<Contact> getContacts(String sortField, String sortOrder) 
	{
		...
		try 
		{
			...
			while (!cursor.isAfterLast())
			{
				...
				newContact.setMemo(cursor.getString(11));
	...
	/*public void updateMemo(contactId,String memo)
	{
		
			String query="UPDATE contact set memo ="+memo+"where _id="+contactId;
	...
	{ //1
		...
		{ //3
			...
			contact.setMemo(cursor.getString(11));
			Time t = new Time();
			t.set(Long. valueOf (cursor.getString(9)));
